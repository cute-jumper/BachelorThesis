...
在\onlinecite{weiner1973linear}中提出了后缀树的概
念，Ukkonen在\onlinecite{ukkonen1995line}中提出了一个$O(n)$时间复杂度的在线构造算
法。
...
复记录检测的模块，我们的系统实现了Ukkonen在\onlinecite{ukkonen1995line}中提出的时
