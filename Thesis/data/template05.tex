...
必选节点，顾名思义就是在该模板生成的网页中，必选节点中包含的所有模板节点都应该出
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{template05/django-if}
